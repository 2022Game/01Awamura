...
#include <string>
void CTexture2::Load(const char* filename)
{
	//ファイルオープン
...
void CTexture2::Draw(float left, float right, float bottom, float top, float tleft, float tright, float tbottom, float ttop) {
	DrawImage(left, right, bottom, top, tleft, tright, tbottom, ttop);
}

void CTexture2::DrawImage(float left, float right, float bottom, float top, float tleft, float tright, float tbottom, float ttop) const
{
	//テクスチャを有効にする
...
void CTexture2::Draw(float left, float right, float bottom, float top, int tleft, int tright, int tbottom, int ttop) const
{
	DrawImage(left, right, bottom, top, tleft, tright, tbottom, ttop);
}

void CTexture2::DrawImage(float left, float right, float bottom, float top, int tleft, int tright, int tbottom, int ttop) const
{
...
void CTexture2::SetParts(int row, int col) {
	mRow = row;
	mCol = col;
}

void CTexture2::DrawImage(float left, float right, float bottom, float top, int index) {
...
const STgamHeader& CTexture2::Header() const
{
	return mHeader;
}

const GLuint& CTexture2::Id() const
{
	return mId;
}
...
//行数列数の設定
//SetRowCol(行数, 列数)
void CTexture2::SetRowCol(int row, int col) {
	mRow = row;
	mCol = col;
}