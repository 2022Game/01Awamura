...
{
	mRectangle.Render(600.0f, 600.0f, 600.0f, 100.0f);
	mRectangle.Render(600.0f, 20.0f, 600.0f, 20.0f);
	mteki.Render(550.0f,400.0f,20.0f,40.0f);
	mteki.Render(500.0f, 200.0f, 20.0f, 40.0f);
	mmy.Render(50.0f, 320.0f, 20.0f, 40.0f);
	/*switch (mState)
	{
	case EState::EPLAY:
		mpGame->Update();
