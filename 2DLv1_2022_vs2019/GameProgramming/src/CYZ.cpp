...
void CYZ::Update()
{
	...
	if (sNow1 == 0)
	{
		if (sNow3 == sNow2)
		{
			CApplication::CharacterManager()->Add(
				new CYmigi(753.0f, 80.0f, 16.0f, 16.0f,
					CApplication::Texture5()));
			CApplication::CharacterManager()->Add(
				new CYmigi(753.0f, 112.0f, 16.0f, 16.0f,
					CApplication::Texture5()));
			CApplication::CharacterManager()->Add(
				new CYhidari(47.0f, 528.0f, 16.0f, 16.0f,
					CApplication::Texture4()));
			CApplication::CharacterManager()->Add(
				new CYhidari(47.0f, 496.0f, 16.0f, 16.0f,
					CApplication::Texture4()));
			sNow3 = 10000;
		}
	}
	...
	if (sNow1 == 3)
	{
		...
		{
			CApplication::CharacterManager()->Add(
				new CZkam(1395.0f, 160.0f, 600.0f, 32.0f,
					CApplication::Texture()));
			sNow3 = sNow2;
		}
	}
